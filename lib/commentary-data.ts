  ...
  'genesis_3_1': [
    {
      ...
      authorHandle: '@TriedByFire',
      profileImageUrl: undefined,
      text: `Here, we are introduced to Satan. One of the most dangerous, deadly, and (apparently) most subtle of all creatures that God has designed is the snake, and how fitting it is for Satan to show up in this manner. What is interesting to me, however, is that this was a talking snake. I don't know about you, but if a snake talked to me, I would think I was either going crazy or there was something wrong with that snake!`,
      likes: 0,
      isLikedByUser: false,
      isBookmarkedByUser: false,
      createdAt: new Date().toISOString(),
    },
    {
      ...
      authorHandle: '@TriedByFire',
      profileImageUrl: undefined,
      text: `"And the great dragon was cast out, that old serpent, called the Devil, and Satan, which deceiveth the whole world: he was cast out into the earth, and his angels were cast out with him." Revelation 12:9`,
      likes: 0,
      isLikedByUser: false,
      isBookmarkedByUser: false,
      createdAt: new Date().toISOString(),
    },
    {
      ...
      authorHandle: '@TriedByFire',
      profileImageUrl: undefined,
      text: `Now, we can get into the origin of Satan and how he ends up here in this garden paradise, but I don't want to draw away from the main focus of Scripture in this chapter of Genesis. There may be time for that when we go through Isaiah 14 or Ezekiel 28. Apparently, Eve didn't think it was too big of a deal seeing as she is seen literally conversing with the snake. This could be the reason that she was easily tempted into what is about to come next.`,
      likes: 0,
      isLikedByUser: false,
      isBookmarkedByUser: false,
      createdAt: new Date().toISOString(),
    },
    {
      ...
      authorHandle: '@TriedByFire',
      profileImageUrl: undefined,
      text: `She might have thought that the fact that the snake could talk meant that God has a special purpose for this snake. Honestly, they aren't even warned about Satan beforehand. They are just warned about what would happen to them if they take from that tree. They KNEW God was telling the truth about that tree, yet they still had a hard time believing it.`,
      likes: 0,
      isLikedByUser: false,
      isBookmarkedByUser: false,
      createdAt: new Date().toISOString(),
