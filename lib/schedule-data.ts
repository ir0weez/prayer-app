...
export const EVENT_KEYWORD_MAP: EventKeyword[] = [
  ...
  { keywords: ["therapy", "therapist", "counseling", "counselling", "counselor"], label: "Therapy", emoji: "🧠", icon: "psychology", bgColor: "#F3E8FF", textColor: "#6B21A8", accentColor: "#9333EA" },
  ...
  { keywords: ["gardening", "garden", "planting", "plants", "yard work", "yard", "lawn", "grass"], label: "Gardening", emoji: "🌿", icon: "yard", bgColor: "#ECFDF5", textColor: "#166534", accentColor: "#16A34A" },
  ...
  { keywords: ["basketball"], label: "Basketball", emoji: "🏀", icon: "sports-basketball", bgColor: "#FFF3E0", textColor: "#E65100", accentColor: "#FF9800" },
