...
const inputPath = '/home/ubuntu/upload/Deuteronomy31-34.txt';
...
if (/['"]deuteronomy_(?:3[1-4])_\d+['"]\s*:/.test(source)) {
  throw new Error('Deuteronomy 31–34 entries already exist; import stopped to avoid duplicates.');
}
...
const importedNotes = notes.filter((note) => note.chapter >= 31 && note.chapter <= 34);
if (importedNotes.length === 0) throw new Error('No Deuteronomy 31–34 comments were parsed.');
