...
const inputPath = '/home/ubuntu/upload/Joshua11-20.txt';
...
if (/['"]joshua_(?:1[1-9]|20)_\d+['"]\s*:/.test(source)) {
  throw new Error('Joshua 11–20 entries already exist; import stopped to avoid duplicates.');
}
...
if (importedNotes.length === 0) throw new Error('No Joshua 11–20 comments were parsed.');
