...
def main():
    ...
    known = {'Deuteronomy', 'Joshua', 'Ruth', '1 Samuel', '2 Samuel', '1 Kings', '2 Kings', 'Proverbs', 'Ecclesiastes', 'Song of Solomon', 'Isaiah', 'Obadiah', 'Jonah', 'Mark'}; books: dict[str, list[str]] = {}; current = None
    for raw in lines:
        stripped = raw.strip()
