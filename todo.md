...
- [x] BUG: Scroll doesn't go all the way to top (summary card blocking full scroll) — FINAL FIX: Used sticky headers (stickyHeaderIndices=[0,1]) so summary and date header are part of FlatList scroll context, with date header scrolling over summary
