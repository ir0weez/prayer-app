...
## New Feature - May 20, 2026

- [x] Implement expandable/collapsible family cards on home screen
  - [x] Add expand/collapse state management per family
  - [x] Show all family members in expanded view
  - [x] Add chevron icons for expand/collapse visual feedback
  - [x] Close expanded card when tapping on collapse button
